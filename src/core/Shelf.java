...
//theBooks.size()<1
	...
	public static boolean addBook(Book book) {
		...
		return addBook(book.getId(),book.getAuthor(),book.getTitle(),book.getPages());
	...
	public static List<Book> getAllBooksForAuthor(String author) {
		...
		List<Book> authorsstore = new ArrayList<>();
...
for(int i=0; i<theBooks.size();i++) {
	 ...
	 *               needed
	 */							//"kaithy"
	public static void removeBook(String author) {   //"Grid",","JavaBook",Best Age"
													//2//"Best Age","JavaBook"	
		for(int i=0; i<theBooks.size();i++) {
